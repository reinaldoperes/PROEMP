          ...
          <Card>
            ...
            <GridItem xs={12} sm={12} md={5}>
                ...
                <select
                    ...
                    {listaReferencias.map(ref => {
                        return <option key={ref.key} value={ref.key}>{ref.nome}</option>;
                    })}
                </select>
            </GridItem>
            <GridItem xs={12} sm={12} md={5}>
            ...
            <GridContainer>
                ...
                <Autocomplete
                    ...
                    style={{ width: '100%' }}
                    renderInput={(params) => <TextField {...params} name="email" label="Para:" variant="outlined" />}
                />                
                </GridItem>
            </GridContainer>
              <br />
            <GridContainer>
                <GridItem xs={12} sm={12} md={10}>
                <TextField autoFocus required id="titulo" name="titulo" fullWidth label="Assunto" />                
                </GridItem>
              </GridContainer>
              <br />
              <GridContainer>
