...
export default function AtualizarTipoDocumento(props) {
  ...
  const handleSubmit = event => {
    ...
    let tipodoc = firebase.database().ref('tipo_documento').child(props.location.state.key);
        ...
        <GridItem xs={12} sm={12} md={8}>
          <Card>
            ...
            <CardBody>
              ...
              <br /><br />
              <Button type="submit" color="warning">Atualizar</Button>
